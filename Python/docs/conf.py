...
def find_description(*file_paths):
    """
    Build a path from *file_paths* and search for a ``__description__``
    string inside.
    """
    description_file = read(*file_paths)
    description_match = re.search(r"^__description__ = ['\"]([^'\"]*)['\"]",
                                  description_file, re.M)
...
release = find_version("../pyadhan/__init__.py")
