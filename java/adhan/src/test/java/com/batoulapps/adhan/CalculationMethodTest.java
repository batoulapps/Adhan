...
public class CalculationMethodTest {
  ...
  public void testCalculationMethods() {
    ...
    assertThat(params.ishaAngle).isWithin(0.001).of(17);
    ...
    assertThat(params.fajrAngle).isWithin(0.001).of(20);
    assertThat(params.ishaAngle).isWithin(0.001).of(18);
    assertThat(params.ishaInterval).isEqualTo(0);
    ...
    assertThat(params.fajrAngle).isWithin(0.001).of(19.5);
    assertThat(params.ishaAngle).isWithin(0.001).of(0);
    assertThat(params.ishaInterval).isEqualTo(90);
    ...
    assertThat(params.fajrAngle).isWithin(0.001).of(15);
    assertThat(params.ishaAngle).isWithin(0.001).of(15);
    assertThat(params.ishaInterval).isEqualTo(0);
    assertThat(params.method).isEqualTo(CalculationMethod.NORTH_AMERICA);

    params = CalculationMethod.OTHER.getParameters();
    assertThat(params.fajrAngle).isWithin(0.001).of(0);
    assertThat(params.ishaAngle).isWithin(0.001).of(0);
    assertThat(params.ishaInterval).isEqualTo(0);
